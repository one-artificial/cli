/// Compaction prompts for context summarization.
...
/// Format the compact summary output.
pub fn format_compact_summary(summary: &str) -> String {
    ...
    {
        let content = &result[start + 9..end];
        result = format!(
            "{}Summary:\n{}{}",
            &result[..start],
            content.trim(),
...
/// Build the user-facing summary message after compaction
/// Build the user-facing summary message after compaction.
